...
export class N8nLlmTracing extends BaseCallbackHandler {
	...
	async handleLLMStart(llm: Serialized, prompts: string[], runId: string) {
		...
		const currentRunIndex = (this.executionFunctions as unknown as { runIndex?: number }).runIndex ?? 0;
		const sourceNodeRunIndex = this.#parentRunIndex !== undefined ? this.#parentRunIndex + currentRunIndex : undefined;
